...
You can find how core [concepts of a state machine](docs/01-intro) are implemented in the
[documentation](docs/02-implementation) or you can dive directly into the code.
