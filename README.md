...
You can find how core [concepts of a state machine](docs/intro.md) are implemented in the
[documentation](docs/implementation.md) or you can dive directly into the code.
